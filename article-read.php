...
if ($id > 0)
{
	...
	if ( ! array_key_exists('type', $result))
	{
		...
		$related_articles = get_related_article_list($tmp_cat_id, $article['title'], 5);
...
$smarty->assign('latest_articles', art_load_articles(0, 5));
$smarty->assign('popular_articles', art_load_articles(0, 5, '', '', array(), 'views'));
